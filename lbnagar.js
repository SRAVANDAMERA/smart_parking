...
function generateBookingId() {
    const prefix = 'LBN'; // Prefix for LB Nagar
...
function updateHistoryTable() {
    ...
    // Filter bookings for LB Nagar location
    const locationBookings = bookingHistory.filter(booking => booking.location === 'LB Nagar');
...
function updateAvailabilityDisplay() {
    ...
    // Filter bookings for today and LB Nagar location
    const todayBookings = bookingHistory.filter(booking => 
        booking.date === today && booking.location === 'LB Nagar'
    );
