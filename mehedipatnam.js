...
function generateBookingId() {
    const prefix = 'MEH'; // Prefix for Mehedipatnam
...
function updateHistoryTable() {
    ...
    // Filter bookings for Mehedipatnam location
    const locationBookings = bookingHistory.filter(booking => booking.location === 'Mehedipatnam');
...
function updateAvailabilityDisplay() {
    ...
    // Filter bookings for today and Mehedipatnam location
    const todayBookings = bookingHistory.filter(booking => 
        booking.date === today && booking.location === 'Mehedipatnam'
    );
