...
function generateBookingId() {
    const prefix = 'HTC'; // Prefix for Hitech City
...
function updateHistoryTable() {
    ...
    // Filter bookings for Hitech City location
    const locationBookings = bookingHistory.filter(booking => booking.location === 'Hitech City');
...
function updateAvailabilityDisplay() {
    ...
    // Filter bookings for today and Hitech City location
    const todayBookings = bookingHistory.filter(booking => 
        booking.date === today && booking.location === 'Hitech City'
    );
