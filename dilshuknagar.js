...
function generateBookingId() {
    const prefix = 'DIL'; // Prefix for Dilshuknagar
...
function updateHistoryTable() {
    ...
    // Filter bookings for Dilshuknagar location
    const locationBookings = bookingHistory.filter(booking => booking.location === 'Dilshuknagar');
...
function updateAvailabilityDisplay() {
    ...
    // Filter bookings for today and Dilshuknagar location
    const todayBookings = bookingHistory.filter(booking => 
        booking.date === today && booking.location === 'Dilshuknagar'
    );
